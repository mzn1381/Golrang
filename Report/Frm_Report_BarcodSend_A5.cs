...
{
    public partial class Frm_Report_BarcodSend_A5 : Form
    {
        ...
        string Report;
        public Frm_Report_BarcodSend_A5(string NumberD)
        {
            Report = NumberD;
            InitializeComponent();
        }

        private void Frm_Report_BarcodSend_A5_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                stireport.Load("barcodsend-A5.mrt");
