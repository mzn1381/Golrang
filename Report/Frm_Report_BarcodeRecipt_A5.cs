...
{
    public partial class Frm_Report_BarcodeRecipt_A5 : Form
    {
        ...
        string _Report;
        public Frm_Report_BarcodeRecipt_A5(string NumberD)
        {
            _Report = NumberD;
            InitializeComponent();
        }

        private void Frm_Report_BarcodeRecipt_A5_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                stireport.Load("barcodRecipt-A5.mrt");
