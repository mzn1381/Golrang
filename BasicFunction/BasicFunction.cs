...
namespace PCLOR.MyBasicFunction
{
    ...
    {
        public static void LoadDevices(EventHandler Button_Click, SqlConnection ConPCLOR, string connection,Class_Documents ClDoc,Control.ControlCollection Controls)
        {
