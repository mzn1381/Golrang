...
{
    public partial class Frm_006_Handcheckback : Form
    {
        ...
        private void btn_Delete_Click(object sender, EventArgs e)
        {
            try
            {
                if (UserScope.CheckScope(Class_BasicOperation._UserName, "Column44", 113))
                {
        ...
        private void Frm_006_Handcheckback_Load(object sender, EventArgs e)
        {
            ...
            string status = ClDoc.ExScalar(ConBank.ConnectionString, @"select isnull((select ColumnId from Table_060_ChequeStatus where Column15=5 AND Column09=103100),0)");
...
WHERE     (TurnReception.LastState in (select ColumnId from Table_060_ChequeStatus where Column15=1 )) AND (Table_065_TurnReception_2.Column01 <> 0) AND (dbo.Table_060_ChequeStatus.Column15 = 1) AND (dbo.Table_035_ReceiptCheques.Column42 = N'" + Class_BasicOperation._UserName + "') AND (Table_065_TurnReception_2.Column16 = N'" + Class_BasicOperation._UserName + "')");
        ...
        private void Update_Click(object sender, EventArgs e)
        {
            ...
            Frm_006_Handcheckback_Load(sender, e);
        }
