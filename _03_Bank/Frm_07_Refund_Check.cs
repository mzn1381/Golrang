...
{
    public partial class Frm_07_Refund_Check : Form
    {
        ...
        public Frm_07_Refund_Check()
        {
            InitializeComponent();
        }

        private void Frm_07_Refund_Check_Load(object sender, EventArgs e)
        {
            ...
            mlt_status.DataSource = ClDoc.ReturnTable(ConBank, @"select ColumnID,Column15,Column02 from Table_060_ChequeStatus where Column15 =7");
            string Bed = ClDoc.ExScalar(ConBank.ConnectionString, @"select isnull((select Column03 from  Table_060_ChequeStatus  where Column15=7),0)");
            string Bes = ClDoc.ExScalar(ConBank.ConnectionString, @"select isnull((select Column09 from Table_060_ChequeStatus where Column15=7),0)");
            string status = ClDoc.ExScalar(ConBank.ConnectionString, @"select isnull((select ColumnId from Table_060_ChequeStatus where Column15=7),0)");
            ...
            gridEX1.DropDowns["Status"].DataSource = ClDoc.ReturnTable(ConBank, @"select ColumnId,Column02 from Table_060_ChequeStatus");
            ...
            if (isadmin)
            {
                gridEX1.DataSource = ClDoc.ReturnTable(ConBank, @"SELECT        dbo.Table_065_TurnReception.Column01 AS PaperID, dbo.Table_065_TurnReception.ColumnId AS LastTurnID, 
                         dbo.Table_065_TurnReception.Column02 AS LastState, dbo.Table_035_ReceiptCheques.Column00 AS BackNum, dbo.Table_035_ReceiptCheques.Column01, 
                         dbo.Table_035_ReceiptCheques.Column02 AS DateRecipt, dbo.Table_035_ReceiptCheques.Column03 AS NumberCheck, 
                         dbo.Table_035_ReceiptCheques.Column04 AS DateSRecipt, dbo.Table_035_ReceiptCheques.Column05 AS Price, 
                         dbo.Table_060_ChequeStatus.Column15 AS Statuse, dbo.Table_035_ReceiptCheques.Column09 AS NumberHesab, 
                         dbo.Table_035_ReceiptCheques.Column42 AS UserSabt, dbo.Table_035_ReceiptCheques.Column43 AS DateSabt, 
                         dbo.Table_065_TurnReception.Column06 AS TurnBankBox, dbo.Table_035_ReceiptCheques.Column07 AS Person, dbo.Table_060_ChequeStatus.Column03 AS Bes, 
                         dbo.Table_035_ReceiptCheques.Column06 AS Babat, dbo.Table_035_ReceiptCheques.ColumnId, dbo.Table_065_TurnReception.Column20, 
                         dbo.Table_065_TurnReception.Column21, dbo.Table_065_TurnReception.Column19 AS TurnDes, dbo.Table_065_TurnReception.Column22, 
                         dbo.Table_065_TurnReception.Column07 AS TurnACC, dbo.Table_065_TurnReception.Column13 AS TurnSanad, dbo.Table_065_TurnReception.Column16, 
                         dbo.Table_020_BankCashAccInfo.Column02 AS MainBankName, dbo.Table_035_ReceiptCheques.Column46
FROM            dbo.Table_065_TurnReception INNER JOIN
                         dbo.Table_060_ChequeStatus ON dbo.Table_065_TurnReception.Column02 = dbo.Table_060_ChequeStatus.ColumnId INNER JOIN
                         dbo.Table_035_ReceiptCheques ON dbo.Table_065_TurnReception.Column01 = dbo.Table_035_ReceiptCheques.ColumnId INNER JOIN
                         dbo.Table_020_BankCashAccInfo ON dbo.Table_035_ReceiptCheques.Column01 = dbo.Table_020_BankCashAccInfo.ColumnId
WHERE     (dbo.Table_060_ChequeStatus.Column15 IN (1,  5)) AND (dbo.Table_065_TurnReception.Column13 <> 0) AND (dbo.Table_065_TurnReception.ColumnId IN
...
WHERE     (dbo.Table_060_ChequeStatus.Column15 IN (1,  5)) AND (dbo.Table_065_TurnReception.Column13 <> 0) AND (dbo.Table_065_TurnReception.ColumnId IN
                          (SELECT     MAX(ColumnId) AS Expr1
                            FROM          dbo.Table_065_TurnReception AS Table_065_TurnReception_1
                            WHERE      (Column13 <> 0)
                            GROUP BY Column01)) AND (dbo.Table_035_ReceiptCheques.Column42 = N'" + Class_BasicOperation._UserName + "')  AND (dbo.Table_065_TurnReception.Column16 = N'" + Class_BasicOperation._UserName + "')");
            }
        ...
        private void btn_Save_Click(object sender, EventArgs e)
        {
            ...
            int _TurnID = 1;
            string PayStatuse = gridEX1.GetValue("Statuse").ToString();
            try
            {
                ...
                if (gridEX1.GetCheckedRows().Length > 0)
                {
                     ...
                     if (MessageBox.Show("آیا مایل به صدور سند حسابداری هستید؟", "توجه", MessageBoxButtons.YesNo) == DialogResult.Yes)
                    {
                        ...
                        string Bes = (gridEX1.GetValue("Bes").ToString());
                        string BesPerson = (gridEX1.GetValue("Column46").ToString());
                        string BesCenter = "NULL";
                        string BesProject = "NULL";
                        string BedProject = "NULL";
                        string BedPerson = (gridEX1.GetValue("Person").ToString());
                            ...
                            foreach (GridEXRow item in gridEX1.GetCheckedRows())
                            {
                                ...
                                DateTime DateR = Convert.ToDateTime(FarsiLibrary.Utils.PersianDateConverter.ToGregorianDate(FarsiLibrary.Utils.PersianDate.Parse(item.Cells["DateSRecipt"].Value.ToString())));
                                ...
                                BesPerson = (item.Cells["Column46"].Value.ToString());
                                    ...
                                    BedPerson = "NULL";
                                    BedProject = "NULL";
                                    BedPerson = (item.Cells["Person"].Value.ToString());
                                    ...
                                    Bes = item.Cells["Bes"].Value.ToString();
                                    //string best = item.Cells["Column01"].Value.ToString();
                                    //Bes = ClDoc.ExScalar(ConBank.ConnectionString, "SELECT        Column09 FROM            dbo.Table_060_ChequeStatus WHERE        (ColumnId = 104) ", item.Cells["Column01"].Value.ToString());
                                    string[] _Bes_Info = ClDoc.ACC_Info(Bes);
                                    //Bes Person
                                    if (item.Cells["Statuse"].Value.ToString() == "2")
                                    {
                                        BesPerson = BedPerson;
                                        //BedPerson = "NULL";
                                    }
                                    ...
                                    if (item.Cells["Column20"].Value.ToString() == "False")
                                    {
                                        ...
                                        Convert.ToInt64(Convert.ToDouble(item.Cells["Price"].Value.ToString())), 0, 0, 0, -1,
                                    ...
                                    else
                                    {
                                      ...
                                      BedProject, item.Cells["Sharh"].Text.Trim(),
                                       Convert.ToInt64(Convert.ToDouble(item.Cells["Price"].Value.ToString()) *
                                       Convert.ToDouble(item.Cells["Column22"].Value.ToString())), 0,
                                       Convert.ToDouble(item.Cells["Price"].Value.ToString()), 0,
                                    ...
                                    if (item.Cells["Column20"].Value.ToString() == "False")
                                    {
                                        CommandText = CommandText + (ExportDoc_Detail(DocID, Bes, Int16.Parse(_Bes_Info[0].ToString()), _Bes_Info[1].ToString(), _Bes_Info[2].ToString(), _Bes_Info[3].ToString(),
                                            ...
                                            Convert.ToInt64(Convert.ToDouble(item.Cells["Price"].Value.ToString())), 0, 0, -1,
                                    ...
                                    else
                                    {
                                        ...
                                        Convert.ToInt64(Convert.ToDouble(item.Cells["Price"].Value.ToString()) *
                                        Convert.ToDouble(item.Cells["Column22"].Value.ToString())), 0,
                                        Convert.ToDouble(item.Cells["Price"].Value.ToString()),
                                        Int16.Parse(item.Cells["Column21"].Value.ToString()),
                                        Int16.Parse(mlt_status.Value.ToString()), _TurnID, Class_BasicOperation._UserName,
                                        Convert.ToDouble(item.Cells["Column22"].Value.ToString()), 0, faDatePicker1.Text);
                                    }
                                ...
                                if (_ShowMsg)
                                {
                                    ...
                                    mlt_Bed.Value = null;
                                    mlt_Bes.Value = null;
                                    Frm_07_Refund_Check_Load(sender, e);
                                }
...
int SanadID, string Center, string Project, string User, string Description, string Currency, string CurrencyType, Double CurrencyValue)
    ...
    Int64 Bes, Double CurBed, Double CurBes, Int16 CurType, Int16 SanadType, int Ref, string RegUser, Double CurPrice, object Period, object EffDate)
        ...
        private void CheckEssentialItems()
        {
            ...
            if (txt_Cover.Text.Trim() == "" || faDatePicker1.Text.Trim() == "" || faDatePicker1.Text.Trim().Length > 10 || mlt_Bed.Text.Trim() == "" )
            ...
            foreach (GridEXRow item in gridEX1.GetCheckedRows())
            {
                ...
                //سرفصل بستانکار
                string Bes = (item.Cells["Bes"].Value.ToString());

                


                //شخص بستانکار
                if (item.Cells["Person"].Text.Trim() != "")
                    BesPerson = int.Parse(item.Cells["Person"].Value.ToString());
            ...
            try
            {
                ...
                if (e.ChangeType == Janus.Windows.GridEX.CheckStateChangeType.RowChange)
                {
                    if (e.CheckState == Janus.Windows.GridEX.RowCheckState.Checked)
                    {
                        ...
                        mlt_status.Text,
                        e.Row.Cells["DateRecipt"].Text.Trim(), e.Row.Cells["DateSRecipt"].Text.Trim(),
                        e.Row.Cells["NumberCheck"].Text.Trim(),
                        e.Row.Cells["TurnBankBox"].Text.Trim(),//e.Row.Cells["MainBankName"].Text,
                       "",
                        "",
                            ///چون رشته شخص خالی است پس شخص مقابل اینجا خالی می شود
                           "",
                         e.Row.Cells["Babat"].Text.Trim(),
        ...
        private void btn_Delete_Click(object sender, EventArgs e)
        {
            try
            {
                if (UserScope.CheckScope(Class_BasicOperation._UserName, "Column44", 107))
                {
...
//        {
//            if (((DataRowView)mlt_status.DropDownList.FindItem(mlt_status.Value))["Column15"].ToString()=="1")
//            {
...
//                      Table_065_TurnReception_2.Column22
...
//                      dbo.Table_060_ChequeStatus ON Table_065_TurnReception_2.Column02 = dbo.Table_060_ChequeStatus.ColumnId
//WHERE     (Table_065_TurnReception_2.Column01 <> 0) AND (dbo.Table_060_ChequeStatus.Column15 = 1) AND (TurnReception.LastState = 100)");
//            }
//            if (((DataRowView)mlt_status.DropDownList.FindItem(mlt_status.Value))["Column15"].ToString()=="3")
//            {
//                             gridEX1.DataSource = ClDoc.ReturnTable(ConBank, @"SELECT     dbo.Table_035_ReceiptCheques.ColumnId, dbo.Table_035_ReceiptCheques.Column00, dbo.Table_035_ReceiptCheques.Column01, dbo.Table_035_ReceiptCheques.Column02, 
//                      dbo.Table_035_ReceiptCheques.Column03, dbo.Table_035_ReceiptCheques.Column04, dbo.Table_035_ReceiptCheques.Column05, dbo.Table_035_ReceiptCheques.Column06, 
//                      dbo.Table_035_ReceiptCheques.Column07, dbo.Table_035_ReceiptCheques.Column08, dbo.Table_035_ReceiptCheques.Column09, dbo.Table_035_ReceiptCheques.Column10, 
...
//                      dbo.Table_065_TurnReception AS Table_065_TurnReception_2 ON dbo.Table_035_ReceiptCheques.ColumnId = Table_065_TurnReception_2.Column01 INNER JOIN
//                      dbo.Table_060_ChequeStatus ON Table_065_TurnReception_2.Column02 = dbo.Table_060_ChequeStatus.ColumnId
//WHERE     (Table_065_TurnReception_2.Column01 <> 0) AND (dbo.Table_060_ChequeStatus.Column15 = 3) AND (TurnReception.LastState = 101)");
//            }
//                 if (((DataRowView)mlt_status.DropDownList.FindItem(mlt_status.Value))["Column15"].ToString()=="4")
//                {
//          gridEX1.DataSource = ClDoc.ReturnTable(ConBank, @"SELECT     dbo.Table_035_ReceiptCheques.ColumnId, dbo.Table_035_ReceiptCheques.Column00, dbo.Table_035_ReceiptCheques.Column01, dbo.Table_035_ReceiptCheques.Column02, 
//                      dbo.Table_035_ReceiptCheques.Column03, dbo.Table_035_ReceiptCheques.Column04, dbo.Table_035_ReceiptCheques.Column05, dbo.Table_035_ReceiptCheques.Column06, 
//                      dbo.Table_035_ReceiptCheques.Column07, dbo.Table_035_ReceiptCheques.Column08, dbo.Table_035_ReceiptCheques.Column09, dbo.Table_035_ReceiptCheques.Column10, 
...
//                      dbo.Table_065_TurnReception AS Table_065_TurnReception_2 ON dbo.Table_035_ReceiptCheques.ColumnId = Table_065_TurnReception_2.Column01 INNER JOIN
//                      dbo.Table_060_ChequeStatus ON Table_065_TurnReception_2.Column02 = dbo.Table_060_ChequeStatus.ColumnId
//WHERE     (Table_065_TurnReception_2.Column01 <> 0) AND (dbo.Table_060_ChequeStatus.Column15 = 4) AND (TurnReception.LastState = 102)");
//                }
//            if (((DataRowView)mlt_status.DropDownList.FindItem(mlt_status.Value))["Column15"].ToString()=="4")
//    {
//           gridEX1.DataSource = ClDoc.ReturnTable(ConBank, @"SELECT     dbo.Table_035_ReceiptCheques.ColumnId, dbo.Table_035_ReceiptCheques.Column00, dbo.Table_035_ReceiptCheques.Column01, dbo.Table_035_ReceiptCheques.Column02, 
...
//                      dbo.Table_065_TurnReception AS Table_065_TurnReception_2 ON dbo.Table_035_ReceiptCheques.ColumnId = Table_065_TurnReception_2.Column01 INNER JOIN
//                      dbo.Table_060_ChequeStatus ON Table_065_TurnReception_2.Column02 = dbo.Table_060_ChequeStatus.ColumnId
//WHERE     (Table_065_TurnReception_2.Column01 <> 0) AND (dbo.Table_060_ChequeStatus.Column15 = 2) AND (TurnReception.LastState = 103)");
//    }
//            if (((DataRowView)mlt_status.DropDownList.FindItem(mlt_status.Value))["Column15"].ToString()=="5")
//            {
//                  gridEX1.DataSource = ClDoc.ReturnTable(ConBank, @"SELECT     dbo.Table_035_ReceiptCheques.ColumnId, dbo.Table_035_ReceiptCheques.Column00, dbo.Table_035_ReceiptCheques.Column01, dbo.Table_035_ReceiptCheques.Column02, 
//                      dbo.Table_035_ReceiptCheques.Column03, dbo.Table_035_ReceiptCheques.Column04, dbo.Table_035_ReceiptCheques.Column05, dbo.Table_035_ReceiptCheques.Column06, 
//                      dbo.Table_035_ReceiptCheques.Column07, dbo.Table_035_ReceiptCheques.Column08, dbo.Table_035_ReceiptCheques.Column09, dbo.Table_035_ReceiptCheques.Column10, 
...
//                      dbo.Table_065_TurnReception AS Table_065_TurnReception_2 ON dbo.Table_035_ReceiptCheques.ColumnId = Table_065_TurnReception_2.Column01 INNER JOIN
//                      dbo.Table_060_ChequeStatus ON Table_065_TurnReception_2.Column02 = dbo.Table_060_ChequeStatus.ColumnId
//WHERE     (Table_065_TurnReception_2.Column01 <> 0) AND (dbo.Table_060_ChequeStatus.Column15 = 5) AND (TurnReception.LastState = 104)");
//            }  
